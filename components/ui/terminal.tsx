        ...
        <AnimatePresence mode="wait">
          ...
          <AnimatedTerminalOutput className="mb-4 space-y-4">
            ...
            <AnimatedItem className="text-muted-foreground text-xs ml-4.5">
              This is a terminal style portfolio, a place where{" "}
              <span className="text-foreground">YOU</span> can explore and
              experiment with CLI commands.
            </AnimatedItem>
            <AnimatedItem className="text-muted-foreground text-xs ml-4.5">
              Type <span className="text-foreground">&apos;help&apos;</span> to
              see available commands. Use{" "}
